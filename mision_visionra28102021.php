                        ...
                        <section id="id-100" class="post single">
                            ...
                            <div class="post-header single">
                                 <div style="color: #f42535">
                                    <h3 class="wow fadeInLeft animated">MISIÓN</h3>
                            ...
                            <div style="text-align: justify " id="post-content" class="post-body single wow fadeInLeft animated">
                                <p>&nbsp;                                  </p>
                                <p>Brindar servicios de transporte aéreo de pasajeros y carga, comprometidos con los más altos estándares de seguridad y eficiencia en nuestros procesos, contribuyendo al crecimiento del turismo dominicano y maximizando la rentabilidad de la empresa.</p>
                                <p>
							  ...
							  <div class="post-header single">
                               <div style="color: #f42535">
                                    <h3 class="wow fadeInLeft animated">VISIÓN</h3>
                                    <div class="title-line wow fadeInRight animated"></div>
                                </div>
                            ...
                            <div style="text-align: justify " id="post-content" class="post-body single wow fadeInLeft animated">
                                <p>
                                  Ser la aerolínea dominicana líder en el mercado nacional e internacional, destacados por la calidad y vocación de servicio, garantizando la mejor experiencia de viaje a través del compromiso de nuestros colaboradores. </p>
                                <p>
                                    <img src="assets/img/mision_visionra.jpg" class="img-responsive" alt="Example blog post alt">
                                </p>
