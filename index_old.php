        ...
        <div class="content-area blog-page padding-top-40" style="background-color: #FCFCFC; padding-bottom: 55px;">
            <div class="container" style="width: 100%;">
                <div class="row">
                    ...
                    <div class="box-for overflow">                         
                        <div class="col-md-12 col-xs-12 login-blocks">
                            <h2>Se ha creado exitosamente su cuenta en Aerolineas REDAir.</h2> 
        ...
        <div class="content-area blog-page padding-top-40" style="background-color: #FCFCFC; padding-bottom: 55px;">
            <div class="container" style="width: 100%;">
                <div class="row">
                    ...
                    <div class="box-for overflow">                         
                        <div class="col-md-12 col-xs-12 login-blocks">
                            <h2>Ha ocurrio un error al crear su cuenta en Aerolineas REDAir, por favor intente nuevamente.</h2> 
                            <form action="#" method="post">
 								<div style="height:20px"></div>
                                <div class="text-center">
                                    <button type="button" class="btn btn-default" onclick="javascript:hideRegisterSucess();"> Aceptar</button>
