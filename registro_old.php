                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                     <li class="dropdown ymm-sw " data-wow-delay="0.1s">
                            ...
                            <ul class="dropdown-menu navbar-nav">
                                									<li>
                                    <a href="quienes_somosra">¿Quiénes somos?</a>
                                </li>
																	<li>
                                    <a href="mision_visionra">Misión</a>
                                </li>
																	<li>
                                    <a href="mision_visionra">Visión</a>
                                </li>
																	<li>
                                    <a href="valores_corporativosra">Valores corporativos</a>
                                </li>
																	<li>
                                    <a href="gobierno_corporativo">Gobierno Corporativo</a>
                                </li>
                        ...
                        <section id="id-100" class="post single">
                           ...
                           <form id="form1" action="javascript:sendFormReg()" method="post">
                                <div class="row">
								 ...
								 <label>
                                        <input id="acceptinfo" type="checkbox" value="1">&nbsp;&nbsp;&nbsp;Acepto recibir información sobre REDAir.
                                </label>
 							<br><br>
