                        ...
                        <section id="id-100" class="post single">
                            ...
                            <div class="post-header single">
                                <div style="color: #f42535">
                                    <h3 class="wow fadeInLeft animated">QUIÉNES SOMOS</h3>
                            ...
                            <div style="text-align: justify"id="post-content" class="post-body single wow fadeInLeft animated">
                                <p>&nbsp;                                    </p>
                                <p>Somos una empresa de transporte aéreo, constituida de conformidad con las leyes de la República Dominicana, que tiene programado iniciar operaciones de transporte aéreo comercial y regular de pasajeros y carga en junio del 2021.</p>
                                <p>Mediante el enfoque de servicio, buscamos satisfacer los requerimientos de nuestros clientes y contribuir con el desarrollo de la industria aérea y de la economía en los países donde operamos, siempre bajo los principios de profesionalismo, orgullo y vocación.</p>
                                <p>
                                    <img src="assets/img/quienes_somosra.jpg" class="img-responsive" alt="Example blog post alt">
                                </p>
