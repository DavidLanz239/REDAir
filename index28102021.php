        ...
        <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
					                    <div class="item" style="height:760px;"><img src="assets/img/slides/1135603040d8a3dd8aaaffc5388ab4b3.jpg" alt="Laser Slideshow item" style="height:760px;"  class="img-responsive itempic"></div> 
					                    <div class="item" style="height:760px;"><img src="assets/img/slides/a8ae5f8110bb7ad199fa8f19022f321d.jpg" alt="Laser Slideshow item" style="height:760px;"  class="img-responsive itempic"></div> 
					                </div>
            </div>			
        </div>
                    ...
                    <div class="col-md-12  properties-page">
                        ...
                        <div class="col-md-12 "> 
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="#" ><img src="assets/img/tarifas/0dced123669b6a9632ae6c75d60a5468.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="#">Conoce nuestros destinos</a></h5>
                                            <div class="dot-hr"></div>
                                             <span class="pull-left"><b>Desde </b></span><span class="proerty-price pull-right">Próximamente</span>                                          
                                        </div>
                                    </div>
                                </div>                                  
                             </div>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="#" ><img src="assets/img/tarifas/1a7f1b77db03e5d2a5e15532135f33ea.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="#">Conoce nuestros destinos</a></h5>
                                            <div class="dot-hr"></div>
                ...
                <div class="sl-slider">
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner ">
                            <div class="bg-img bg-img-1" style="background-image: url(assets/img/noticias/264c8870bb40cc7e1c17a3f9d57e065e.jpg);"></div>                             
                            <blockquote><cite><a href="#">Reguladores locales certifican a RED Air como nuevo operador aéreo internacional </a></cite>
                                <p>La nueva aerol&iacute;nea RED Air cuenta con Certificado de Operador A&eacute;reo (AOC), que la reconoce internacionalmente como una aerol&iacute;nea regular, tanto por...</p>
                                     <p> <a href="noticia_single.php?id=40" ><p>
								     <p><a class="btn btn-primary btn-lg" style="background-color:#AF181F; color:white; border: white" href="noticia_single.php?id=40" role="button">Ver más</a></p>
                            </blockquote>
                        </div>
                    </div> 
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner ">
                            <div class="bg-img bg-img-1" style="background-image: url(assets/img/noticias/fd496bd8e1602b2999a0ee69bfc656b3.jpg);"></div>                             
                            <blockquote><cite><a href="#">JAC concede permiso a RED Air para dar servicios regulares de pasajeros</a></cite>
                                <p>La Junta de Aviaci&oacute;n Civil aprob&oacute; la Enmienda N&uacute;mero 1 al Certificado de Autorizaci&oacute;n Econ&oacute;mica (CAE) del operador a&eacute;reo nacio...</p>
                                     <p> <a href="noticia_single.php?id=41" ><p>
								     <p><a class="btn btn-primary btn-lg" style="background-color:#AF181F; color:white; border: white" href="noticia_single.php?id=41" role="button">Ver más</a></p>
                            </blockquote>
                        </div>
                    </div> 
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner ">
                            <div class="bg-img bg-img-1" style="background-image: url(assets/img/noticias/22e5be506f7a12360b49d797b18fd9ab.jpg);"></div>                             
                            <blockquote><cite><a href="#">Bolsos de la tripulación RED Air llevarán sello dominicano</a></cite>
                                <p>Una colaboraci&oacute;n entre&nbsp;RED Air y la dise&ntilde;adora de moda&nbsp;y directora ejecutiva de Fiori, Laur...</p>
                                     <p> <a href="noticia_single.php?id=39" ><p>
								     <p><a class="btn btn-primary btn-lg" style="background-color:#AF181F; color:white; border: white" href="noticia_single.php?id=39" role="button">Ver más</a></p>
                            </blockquote>
                        </div>
                    </div> 
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner ">
                            <div class="bg-img bg-img-1" style="background-image: url(assets/img/noticias/e94e88dc4458637fc426d134e4e3acdd.jpg);"></div>                             
                            <blockquote><cite><a href="#">Más de cincuenta profesionales forman la plantilla de RED Air</a></cite>
                                <p>La nueva compa&ntilde;&iacute;a RED Air ha conformado un equipo de m&aacute;s de cincuenta profesionales dominicanos para poner en marcha sus operaciones. Esto siguiend...</p>
                                     <p> <a href="noticia_single.php?id=38" ><p>
								     <p><a class="btn btn-primary btn-lg" style="background-color:#AF181F; color:white; border: white" href="noticia_single.php?id=38" role="button">Ver más</a></p>
                            </blockquote>
                        </div>
                    </div> 
                                    </div><!-- /sl-slider -->
