                    ...
                    <div class="col-md-12 clear "> 
                        <div id="list-type" class="proerty-th">
                            ...
                            <div class="col-sm-6 col-md-3 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="noticia_single.php?id=40" ><img class="noticiaimagen" src="assets/img/noticias/5aaeb32445f747854ab8c3464bd13ec9.jpg"></a>
                                    </div>

                                    <div class="item-entry overflow" style="height: auto;">
                                        <h5 style="height:50px;width: 100%;"><a href="noticia_single.php?id=40" alt="Reguladores locales certifican a RED Air como nuevo operador aéreo internacional " title="Reguladores locales certifican a RED Air como nuevo operador aéreo internacional ">Reguladores locales certifican a RED Air como nuevo operador aéreo internacional </a></h5>
										 
                                        <div class="dot-hr"></div>
										<span class="">La nueva aerol&iacute;nea RED Air c...</span> 
                                                                           
                                        <p style="display: none;">La nueva aerol&iacute;nea RED Air cuenta con Certificado de Operador A&eacute;reo (AOC), que la reconoce internacionalmente como una aerol&iacute;nea ...</p>
                            ...
                            <div class="col-sm-6 col-md-3 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="noticia_single.php?id=41" ><img class="noticiaimagen" src="assets/img/noticias/a7749a323b2608ccb1b48c55cdf2d6d1.jpg"></a>
                                    </div>

                                    <div class="item-entry overflow" style="height: auto;">
                                        <h5 style="height:50px;width: 100%;"><a href="noticia_single.php?id=41" alt="JAC concede permiso a RED Air para dar servicios regulares de pasajeros" title="JAC concede permiso a RED Air para dar servicios regulares de pasajeros">JAC concede permiso a RED Air para dar servicios regulares de pasajeros</a></h5>
										 
                                        <div class="dot-hr"></div>
										<span class="">La Junta de Aviaci&oacute;n Civil a...</span> 
                                                                           
                                        <p style="display: none;">La Junta de Aviaci&oacute;n Civil aprob&oacute; la Enmienda N&uacute;mero 1 al Certificado de Autorizaci&oacute;n Econ&oacute;mica (CAE) del operador ...</p>
                            ...
                            <div class="col-sm-6 col-md-3 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="noticia_single.php?id=39" ><img class="noticiaimagen" src="assets/img/noticias/869495cc4a53fbccca59b739ff67035a.jpg"></a>
                                    </div>

                                    <div class="item-entry overflow" style="height: auto;">
                                        <h5 style="height:50px;width: 100%;"><a href="noticia_single.php?id=39" alt="Bolsos de la tripulación RED Air llevarán sello dominicano" title="Bolsos de la tripulación RED Air llevarán sello dominicano">Bolsos de la tripulación RED Air llevarán sello dominicano</a></h5>
										 
                                        <div class="dot-hr"></div>
										<span class="">Una colaboraci&oacute;n entre&nbsp;...</span> 
                                                                           
                                        <p style="display: none;">Una colaboraci&oacute;n entre&nbsp;RED Air y la dise&ntilde;adora de moda&nbsp;y directora ejecutiva de Fiori, Laura Pimentel, ha hecho posible que lo...</p>
                            ...
                            <div class="col-sm-6 col-md-3 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="noticia_single.php?id=38" ><img class="noticiaimagen" src="assets/img/noticias/f2730e40894e737188a959a77f8736c3.jpg"></a>
                                    </div>

                                    <div class="item-entry overflow" style="height: auto;">
                                        <h5 style="height:50px;width: 100%;"><a href="noticia_single.php?id=38" alt="Más de cincuenta profesionales forman la plantilla de RED Air" title="Más de cincuenta profesionales forman la plantilla de RED Air">Más de cincuenta profesionales forman la plantilla de RED Air</a></h5>
										 
                                        <div class="dot-hr"></div>
										<span class="">La nueva compa&ntilde;&iacute;a RED...</span> 
                                                                           
                                        <p style="display: none;">La nueva compa&ntilde;&iacute;a RED Air ha conformado un equipo de m&aacute;s de cincuenta profesionales dominicanos para poner en marcha sus operacio...</p>
